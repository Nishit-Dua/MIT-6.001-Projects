...
#
def get_word_score(word: str, letters_in_hand: int):
    """
    ...
    appropriately.
        ...
        The second component is the larger of:
            1, or
            7*wordlen - 3*(letters_in_hand-wordlen), where wordlen
    ...
    returns: int >= 0
    """
    part1 = sum([SCRABBLE_LETTER_VALUES[c.lower()] for c in word])
    part2 = max(((len(word)*7) - (3 * (letters_in_hand - len(word)))), 1)
